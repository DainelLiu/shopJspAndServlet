						...
						<c:forEach items="${orderItem }" var="orderItem">
							<tr>
								...
								<td height="15" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${orderItem.itemid }</div>
								</td>
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
									<c:forEach items="${product }" var="item">
										<c:if test="${item.pid == orderItem.pid}">
											<div align="center">${item.pname}</div>
										</c:if>
									</c:forEach>
								</td>
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
								...
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
									<c:forEach items="${product }" var="item">
										<c:if test="${item.pid == orderItem.pid}">
											<div align="center">${item.markprice}</div>
										</c:if>
									</c:forEach>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<c:forEach items="${product }" var="item">
										<c:if test="${item.pid == orderItem.pid}">
											<div align="center">${item.estoreprice * orderItem.buynum}</div>
										</c:if>
									</c:forEach>
								</td>
							</tr>
								...
								<table width="312" border="0" align="right" cellpadding="0"
									...
									<tr>
										<td width="49">
											<div align="center">
												<span class="STYLE22"> <a
													href="${pageContext.request.contextPath }/AdminServlet?op=findAllAdmin&num=1">首页</a>
												</span>
											</div>
										</td>
										<td width="49">
											<div align="center">
												<span class="STYLE22"> <a
													href="${pageContext.request.contextPath }/AdminServlet?op=findAllAdmin&num=${page.prevPageNum}">上一页</a>
												</span>
											</div>
										</td>
										<td width="49"><span class="STYLE22">
												<div align="center">
													<span class="STYLE22"> <a
														href="${pageContext.request.contextPath }/AdminServlet?op=findAllAdmin&num=${page.nextPageNum}">下一页</a>
													</span>
												</div></td>
										<td width="49">
											<div align="center">
