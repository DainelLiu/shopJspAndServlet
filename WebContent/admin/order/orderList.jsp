		...
		<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="24" bgcolor="#353c44"><table width="100%"
									...
									<tr>
										...
										<td><div align="right">
												<span class="STYLE1"> <!-- <input type="button" value="添加"/> -->
			...
			<tr>
				<td><table width="100%" border="0" cellpadding="0"
						...
						<tr>
							<td width="5%" height="20" bgcolor="d3eaef" class="STYLE10"><div
									align="center">
						...
						<c:forEach items="${page.records }" var="orders">
							<tr>
								<td height="5" bgcolor="#FFFFFF">
									<div align="center">
										<input type="checkbox" name="oid" id="oid"
											value="${orders.oid }" />
									</div>
								</td>
								<td height="15" bgcolor="#FFFFFF" class="STYLE6">
									<div align="center">
										<span class="STYLE19">${orders.oid}</span>
									</div>
								</td>
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${orders.money}</div>
								</td>
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${orders.recipients}</div>
								</td>
								<td height="10" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${orders.tel}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${orders.address}</div>
								</td>
								<td height="15" bgcolor="#FFFFFF" class="STYLE19">
									<c:forEach items="${users }" var="item">
										<c:if test="${item.uid == orders.uid}">
											<div align="center">${item.nickname}</div>
										</c:if>
									</c:forEach>
								</td>
								...
								<td height="15" bgcolor="#FFFFFF">
									...
									<c:if test="${orders.state  == 1}">
											<a href="${pageContext.request.contextPath }/OrderServlet?op=updateOrderSign&oid=${orders.oid}">发货</a>
									</c:if>
									...
									<c:if test="${orders.state  == 3}">
										...
										<a href="${pageContext.request.contextPath }/OrderServlet?op=getOrderItem&oid=${orders.oid}">查看详情</a>
									</div>
								</td>
							</tr>
						</c:forEach>
						...
						<tr>
							<td width="33%"><div align="left">
									<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
											${page.totalRecordsNum }</strong> 条记录，当前第<strong>${page.currentPageNum }</strong>
										页，共 <strong>${page.totalPageNum }</strong> 页
									</span>
								</div></td>
							<td width="67%">
								<table width="312" border="0" align="right" cellpadding="0"
									...
									<tr>
										<td width="49">
											<div align="center">
												<span class="STYLE22"> <a
													href="${pageContext.request.contextPath }/OrderServlet?op=findAllOrder&num=1">首页</a>
												</span>
											</div>
										</td>
										<td width="49">
											<div align="center">
												<span class="STYLE22"> <a
													href="${pageContext.request.contextPath }/OrderServlet?op=findAllOrder&num=${page.prevPageNum}">上一页</a>
												</span>
											</div>
										</td>
										<td width="49"><span class="STYLE22">
												<div align="center">
													<span class="STYLE22"> <a
														href="${pageContext.request.contextPath }/OrderServlet?op=findAllOrder&num=${page.nextPageNum}">下一页</a>
													</span>
												</div></td>
										<td width="49">
											<div align="center">
